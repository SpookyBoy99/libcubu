...
public:
   ...
   * @param hostData Host data to upload to the device.
   */
  void copy_to_device(const std::vector<T>& hostData) const;
   ...
   * @param hostData Host data to upload to the device.
   */
  void copy_to_device(const T* hostData) const;
   ...
   */
  void copy_to_host(std::vector<T>& destData) const;
   ...
   * @param destData Destination for the data on the host.
   */
  void copy_to_host(T* destData) const;
